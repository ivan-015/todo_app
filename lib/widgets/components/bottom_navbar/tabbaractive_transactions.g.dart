...
class TabbaractiveTransactions extends StatefulWidget {
  ...
  const TabbaractiveTransactions(
    this.constraints, {
    Key? key,
    this.ovrWallets,
    this.ovrVector,
  ...
  @override
  _TabbaractiveTransactions createState() => _TabbaractiveTransactions();
}

class _TabbaractiveTransactions extends State<TabbaractiveTransactions> {
  _TabbaractiveTransactions();
