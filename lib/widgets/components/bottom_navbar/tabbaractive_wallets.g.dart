...
class TabbaractiveWallets extends StatefulWidget {
  ...
  @override
  _TabbaractiveWallets createState() => _TabbaractiveWallets();
}

class _TabbaractiveWallets extends State<TabbaractiveWallets> {
  _TabbaractiveWallets();
